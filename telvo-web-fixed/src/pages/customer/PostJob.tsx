        ...
        <Card className="p-6 space-y-5">
          ...
          <div>
            ...
            <div className="flex flex-wrap gap-3">
              ...
              {photos.length < 6 && (
                <label className="w-16 h-16 rounded-lg border-2 border-dashed border-ink-200 flex items-center justify-center cursor-pointer hover:border-brand-500 hover:bg-ink-50 transition-colors text-ink-400">
                  <Camera size={20} />
            ...
            {uploading && photos.length > 0 && (
              <p className="text-xs text-ink-400 mt-2">Uploading {photos.length} photo{photos.length > 1 ? 's' : ''}...</p>
            )}
          </div>
