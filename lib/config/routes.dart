...
import 'package:telvo/screens/customer/hire_worker_screen.dart';
...
import 'package:telvo/screens/professional/hire_requests_screen.dart';
...
import 'package:telvo/screens/settings/blocked_users_screen.dart';
...
class AppRoutes {
  ...
  static Route<dynamic> generateRoute(RouteSettings routeSettings) {
    switch (routeSettings.name) {
      ...
      case hireRequests:
        return MaterialPageRoute(builder: (_) => const HireRequestsScreen());
      case jobFeed:
