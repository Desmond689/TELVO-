...
class ForegroundNotificationManager {
  ...
  void _handleTap(String? type, Map<String, dynamic>? data) {
    // Delegate to the shared router so a tap on the in-app banner routes
    // exactly the same place a tap on the system tray notification would.
    NotificationTapRouter.handle(type, data);
  }
}
