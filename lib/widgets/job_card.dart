                ...
                children: [
                  ...
                  Row(
                    children: [
                      ...
                      if ((job.status == 'accepted' || job.status == 'worker_selected') &&
                          ((job.professionalName != null && job.professionalName!.isNotEmpty) ||
                              (job.professionalId != null && job.professionalId!.isNotEmpty)))
                        Container(
                          ...
                          child: Row(
                            ...
                            children: [
                              CircleAvatar(
                                radius: 10,
                                backgroundImage: (job.professionalImage != null &&
                                        job.professionalImage!.isNotEmpty)
                                    ? NetworkImage(job.professionalImage!)
                                    : null,
                                child: (job.professionalImage == null ||
                                        job.professionalImage!.isEmpty)
                                    ? const Icon(Icons.person, size: 12)
                                    : null,
                              ),
                              const SizedBox(width: 6),
                              Text(
                                'Assigned: ${job.professionalName ?? "Worker"}',
                                style: const TextStyle(
                                  fontSize: 12,
                                  fontWeight: FontWeight.w700,
