...
class UserModel {
  UserModel({
    ...
    this.verificationRejectedCount = 0,
  ...
  factory UserModel.fromMap(Map<String, dynamic> map) {
    return UserModel(
      ...
      verificationDeadline: map['verificationDeadline']?.toDate(),
      verificationSubmittedAt: map['verificationSubmittedAt']?.toDate(),
      verificationRejectedReason: map['verificationRejectedReason'] as String?,
      verificationRejectionReason: map['verificationRejectionReason'] as String? ?? map['verificationRejectedReason'] as String?,
      verificationRejectedAt: map['verificationRejectedAt']?.toDate(),
      verificationRejectedCount: map['verificationRejectedCount'] as int? ?? 0,
  ...
  bool get isTelvoVerified => verificationStatus.toLowerCase() == 'verified' || isVerified;
  ...
  final int verificationRejectedCount;
  ...
  Map<String, dynamic> toMap() => {
    ...
    'verificationRejectedCount': verificationRejectedCount,
  ...
  UserModel copyWith({
    ...
    DateTime? verificationRejectedAt,
    int? verificationRejectedCount,
    bool? isSuspended,
    ...
    verificationRejectedReason: verificationRejectedReason ?? this.verificationRejectedReason,
    verificationRejectionReason: verificationRejectionReason ?? this.verificationRejectionReason,
    verificationRejectedAt: verificationRejectedAt ?? this.verificationRejectedAt,
    verificationRejectedCount: verificationRejectedCount ?? this.verificationRejectedCount,
