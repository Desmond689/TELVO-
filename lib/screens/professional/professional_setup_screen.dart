...
class _ProfessionalSetupScreenState extends State<ProfessionalSetupScreen> {
  ...
  Future<void> _saveProfessionalProfile() async {
    ...
    await authProvider.updateProfile({
      ...
      'categoryNormalized': _categoryController.text.trim().toLowerCase(),
      'skills': _skills,
      ...
      'verificationDeadline': DateTime.now().add(const Duration(days: 7)),
                      ...
                      child: Stack(
                        children: [
                          ClipRRect(
                            borderRadius: BorderRadius.circular(8),
                            child: RemoteImage(
                              imageUrl: _portfolioPhotos[index],
                              width: 80,
                              height: 80,
                              fit: BoxFit.cover,
                            ),
