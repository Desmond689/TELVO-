...
class _ProfessionalDashboardScreenState
  ...
  Widget _buildVerificationBanner(UserModel user) {
    ...
    if (status == 'pending') {
      ...
      message = 'Your identity documents are under review. We will notify you once a decision is made.';
      actionLabel = 'View status';
    } else if (status == 'rejected') {
      title = 'Verification rejected';
      message = user.verificationRejectedReason != null && user.verificationRejectedReason!.isNotEmpty
          ? 'Reason: ${user.verificationRejectedReason}'
          : 'Your last verification attempt was rejected. Please resubmit your documents.';
      actionLabel = 'Retry verification';
    } else {
      title = 'Complete identity verification';
      message = 'Verification increases trust and lets you access more jobs on the platform.';
        ...
        children: [
          ...
          Expanded(
            child: _buildActionCard(
              ...
              AppColors.success,
              () => Navigator.pushNamed(context, AppRoutes.hireRequests),
            ),
          ),
        ],
      ),
