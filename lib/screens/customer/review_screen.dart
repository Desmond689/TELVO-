...
class _ReviewScreenState extends State<ReviewScreen> {
  ...
  Future<void> _submitReview() async {
    ...
    if (_jobId == null || _jobId!.isEmpty) {
      ScaffoldMessenger.of(context).showSnackBar(
        const SnackBar(content: Text('Unable to submit review: missing job information.')),
      );
      return;
    }
    if (_professionalId == null || _professionalId!.isEmpty) {
      ScaffoldMessenger.of(context).showSnackBar(
        const SnackBar(content: Text('Unable to submit review: missing professional information.')),
      );
      return;
    }
        ...
        body: Center(
          child: Padding(
            ...
            child: Column(
              ...
              children: const [
                Text(
                  'Reviews must be submitted from a completed job.',
                  textAlign: TextAlign.center,
                  style: TextStyle(fontSize: 16),
                ),
                SizedBox(height: 12),
                Text(
                  'Please leave a review from your job history or job details screen.',
                  textAlign: TextAlign.center,
